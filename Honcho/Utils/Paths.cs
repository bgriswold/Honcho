...
namespace Honcho.Utils
{
    public class Paths
    {
        ...
        {
            get { return WebRoot + "\\Logs"; }
        }

        public static string LogFile
        {
            get { return LogRoot + "\\Site.log"; }
        }

        public static string ReleaseRoot
        {
            get { return SolutionRoot + "\\Releases"; }
        }

        public static string WebRoot
        {
            get { return SolutionRoot + "\\Web"; }
        }

        public static string PublicDirectory
        {
            get { return WebRoot + "\\Public"; }
        }

        public static string CssDirectory
        {
            get { return PublicDirectory + "\\css"; }
        }

        public string ScriptDirectory
        {
            get { return PublicDirectory + "\\javascript"; }
        }
    }
}